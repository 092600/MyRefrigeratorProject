        ...
        <AutoFocusProvider contentContainerStyle={[styles.keyboardAwareFocus]}>
          ...
          <View style={[styles.view_middle]}>
            ...
            <View style={[styles.middle_menu]}>
              <TouchableOpacity style={[styles.menu]} onPress={goFindId}>
                <Text style={[styles.menu_text]}>아이디 찾기</Text>
              </TouchableOpacity>
              <TouchableOpacity style={[styles.menu, {marginLeft: '-2%',borderBottomColor: '#AED1CF',borderWidth: 2}]} onPress={goFindPW}>
                <Text style={[styles.menu_text, {color: '#A2D9D6'}]}>비밀번호 찾기</Text>
              </TouchableOpacity>
            </View>
            {/* 아이디/비밀번호 찾기 content */}
